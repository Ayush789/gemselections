...
List<Bead> gemstones = [
  ...
  Bead(
    ...
    DialogText:
        "Teen (3)Mukhi Rudraksha (code:ARB03) (FOR ANY QUERY ON Teen (3)Mukhi Rudraksha CALL 0091 - 9213932017) Three Mukhi Rudraksha is a symbol of Brahma, Vishnu and Mahesh. This is considered to be the cause of creation of the three worlds. This curtails the destructive forces within a person and evolves his creativity. This removes the malefic effects of Mars. Quality : Premium,\n\nThree Mukhi Rudraksha Mantra\nThree Mukhi (Kali Namah)\n\nThe Mantra has to be recited on a Rudhraksha mala and should be spoken in such a way that at least you can hear it. Shri Shiv Mahapuran is of the view that Rudhraksha does not give its full results without the use of proper mantras.\n\nRs. 750.00\n\nThree Mukhi Indonesian Rudraksha\nRs. 450.00\n\nThree Mukhi Rudraksha Haridwar\nRs. 300.00 ",
  ),
  Bead(
...
class BeadPage extends StatefulWidget {
  @override
  _BeadPageState createState() => _BeadPageState();
}
...
List<Widget> BeadToRows(List<Bead> gembuttons, BuildContext context) {
