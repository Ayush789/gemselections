...
class _ManikPageState extends State<ManikPage> {
            ...
            content: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text("Rs ${values[v1][0]}"),
                  Text(""),
                  Text("2.25 ratti Manik Stone Rs ${values[v1][1]}/-"),
                  Text("3.25 ratti Manik Stone Rs ${values[v1][2]}/-"),
                  Text("4.25 ratti Manik Stone Rs ${values[v1][3]}/-"),
                  Text("5.25 ratti Manik Stone Rs ${values[v1][4]}/-"),
                  Text("6.25 ratti Manik Stone Rs ${values[v1][5]}/-"),
                  Text("7.25 ratti Manik Stone Rs ${values[v1][6]}/-"),
                  Text("8.25 ratti Manik Stone Rs ${values[v1][7]}/-"),
                  Text("9.25 ratti Manik Stone Rs ${values[v1][8]}/-"),
                  Text("10.25 ratti Manik Stone Rs ${values[v1][9]}/-"),
                  Text("11.25 ratti Manik Stone Rs ${values[v1][10]}/-"),
                ],
              ),
            ),
          );
  ...
  Widget bottomData(int x) {
    ...
    if (x == 3) {
      return Column(
        children: <Widget>[
          Image.network("https://firebasestorage.googleapis.com/v0/b/gemselections-add52.appspot.com/o/AppData%2Fafrican-ruby.jpg?alt=media"),
          Text("At Gem Selections we have a range of African Ruby i.e., Manikya from Rs. 525/ Rt to Rs. 31000/ Rt.\n\nYou can have a look at these collections and decide what you want as per your requirement and budget. \n\nWhat ever you buy comes with a Lab Certificate, bill and Guarantee of purity and originality from our company and its promoter Mr. Pankaj Khanna.\n\nThis is the gem of Sun , it improves the concentration of mind and gives lusture to the skin . This gem gives all round success in life and is the karka for leadership. This improves the leadership qualities and puts the person in forefront . It gives intellectual capabilities and improves one’s writing and speaking powers.")],
      );
    }
    if (x == 4) {
      return Column(
        children: <Widget>[
          Image.network("https://firebasestorage.googleapis.com/v0/b/gemselections-add52.appspot.com/o/AppData%2Fnew-burma-ruby.jpg?alt=media"),
          Text(" <b><u>NEW BURMESE RUBY</u></b>\n\nAt Gem Selections we have a range of new burmese Ruby i.e., Manikya from Rs. 525/ Rt to Rs. 31000/ Rt.\n\nYou can have a look at these collections and decide what you want as per your requirement and budget. \n\nWhat ever you buy comes with a Lab Certificate, bill and Guarantee of purity and originality from our company and its promoter Mr. Pankaj Khanna.\n\nThis is the gem of Sun , it improves the concentration of mind and gives lusture to the skin . This gem gives all round success in life and is the karka for leadership. This improves the leadership qualities and puts the person in forefront . It gives intellectual capabilities and improves one’s writing and speaking powers.")],
      );
    }
     if (x == 5) {
      return Column(
        children: <Widget>[
          Image.network("https://firebasestorage.googleapis.com/v0/b/gemselections-add52.appspot.com/o/AppData%2Fold-burma-ruby.jpg?alt=media"),
          Text("     <b><u>OLD BURMESE RUBY</u></b>\n\nAt Gem Selections we have a range of old burmese Ruby i.e., Manikya from Rs. 525/ Rt to Rs. 31000/ Rt.\n\nYou can have a look at these collections and decide what you want as per your requirement and budget. \n\nWhat ever you buy comes with a Lab Certificate, bill and Guarantee of purity and originality from our company and its promoter Mr. Pankaj Khanna.\n\nThis is the gem of Sun , it improves the concentration of mind and gives lusture to the skin . This gem gives all round success in life and is the karka for leadership. This improves the leadership qualities and puts the person in forefront . It gives intellectual capabilities and improves one’s writing and speaking powers.")],
      );
    }
    return Container();
  }
