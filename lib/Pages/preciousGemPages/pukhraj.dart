            ...
            content: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text("Rs ${values[v1][0]}"),
                  Text(""),
                  Text("2.25 ratti Pukhraj Stone Rs ${values[v1][1]}/-"),
                  Text("3.25 ratti Pukhraj Stone Rs ${values[v1][2]}/-"),
                  Text("4.25 ratti Pukhraj Stone Rs ${values[v1][3]}/-"),
                  Text("5.25 ratti Pukhraj Stone Rs ${values[v1][4]}/-"),
                  Text("6.25 ratti Pukhraj Stone Rs ${values[v1][5]}/-"),
                  Text("7.25 ratti Pukhraj Stone Rs ${values[v1][6]}/-"),
                  Text("8.25 ratti Pukhraj Stone Rs ${values[v1][7]}/-"),
                  Text("9.25 ratti Pukhraj Stone Rs ${values[v1][8]}/-"),
                  Text("10.25 ratti Pukhraj Stone Rs ${values[v1][9]}/-"),
                  Text("11.25 ratti Pukhraj Stone Rs ${values[v1][10]}/-"),
                ],
              ),
            ),
          );
    ...
    if (x == 2) {
      return Column(
        children: <Widget>[
          ...
          Text("<b>Yellow Sapphire:</b> At Gem Selections we have a range of Yellow Sapphire i.e., Pukhraj from Rs. 2100/ Rt to Rs. 31000/ Rt.
\n\n
...
Yellow Sapphire popularity is not based on color alone. Its hardness of 9 places it next to Diamond (10), making it an excellent choice for jewelry worn daily. It is frequently featured in engagement rings. Ceylon (Sri Lanka) positively produces the finest all-round Sapphires in the world today. The very name commands a premium, and Ceylon Gems have constantly increased in price. We have always been on top of the Gem market in Ceylon and stay up with current prices and new discoveries.")
    ...
    if (x == 3) {
      return Column(
        children: <Widget>[Text("     Bangkok Pukhraj is the gemstone ruled by Jupiter.
\n\n
...
We are engaged in trading of yellow sapphire which are well polished and provided with a sound finishing touch.")],
    ...
    if (x == 4) {
      return Column(
        children: <Widget>[
          Image.network("https://firebasestorage.googleapis.com/v0/b/gemselections-add52.appspot.com/o/AppData%2Fpeela-pukhraj-2.jpg?alt=media"),
          Text("<b><u>Treated Pukhraj</u></b> is the gemstone ruled by Jupiter.
\n\n
...
\n\n
At <b>Gem Selections, Janakpuri, New Delhi</b> we have the entire range of Treated Yellow Sapphires i.e. Treated Pukhraj Stone along with the complete range of Natural Yellow Sapphires i.e., Natural Pukhraj Stone but we always inform the customer that a Gemstone has passed through a process for enhancement of its colour and transperancy.
\n\n
...
\n\n
<b>\"WE STRONGLY RECOMMEND THAT YOU MAY BUY A GEMSTONE FROM ANYWHERE BUT BEFORE FINALIZING THIS IMPORTANT DECISION HAVE A LOOK AT OUR COLLECTION AND THE DIFFERENCE BETWEEN A TREATED AND A NATURAL GEMSTONE.\"</b>
\n\n
For children recomended ratti 2 to 2.5, for minor 3 to 4 ratti and for adults 5 to 12 ratti. Ring should be made of only Gold or Silver. Ring should be worn only on Thursday 4 to 7 p.m. and Ring should be worn in Tarjani or Anamica finger.
        \n\n\n
        <b>We have following prices for different quality treated pukhraj available:</b>
        \n\n\t\t 1. Rs. 500 per Ratti
        \n\t\t 2. Rs. 1100 per Ratti
        \n\t\t 3. Rs. 2100 per Ratti
        \n\t\t 4. Rs. 3100 per Ratti
        ...
        \n\n
        And weight available from <b>2.25 ratti to 11.25 ratti</b>.
        \n\n
        Come and have a look at collection. <b>Get Our Address from Visit Us section from Home Page.</b>")
          ],
      );
    }
    return Container();
