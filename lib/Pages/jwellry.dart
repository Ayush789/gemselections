                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        Text(
                          "Why to buy Jwellery from Gem Selections App?\n\n",
                          style: TextStyle(
                        ...
                        Text(
                            "1. You can design your own jewellery using our app.\n"),
                        Text(
                            "2. Gem Selections is the only organisation in India to sell Govt. Lab Certified GemStones, Diamonds and Jewellery.\n"),
                        Text(
                            "3. Buy Jewellery at real - time Gold and Silver rates using the Gem Selectiolns App.\n"),
                      ],
                    ),
                  ),
                  Card(
                      elevation: 10.0,
                      child: Image.asset(
                          "assets/category_create_your_own_cewellery.png")),
                ],
              ),
            ),
          ),
            ...
            child: FlatButton(
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => DiamondJewelleryPage()));
              },
              child: Column(
                children: <Widget>[
                  Card(
              ...
              child: Column(
                children: <Widget>[
                  Card(
                      elevation: 10.0,
                      child: Image.asset(
                          "assets/category_gem_studded_jewellery.png")),
                ],
              ),
            ),
          ),
              ...
              child: Column(
                children: <Widget>[
                  Card(
                      elevation: 10.0,
                      child: Image.asset(
                          "assets/category_victorian_jewellery_.png")),
                ],
              ),
            ),
          ),
                                    ...
                                    MaterialButton(
                                      ...
                                      onPressed: () {
                                        if (_formKey.currentState.validate()) {
                                          crudObj.addData({
                                            'Product No':
                                                jewel_victorian[position],
                                            'Image URL': snap.data
                                                .data[widget.type][position],
                                            'Name': _name.text,
                                            'Email': _email.text,
                ...
                return GridView.count(
                  ...
                  children: List.generate(snap.data.data[widget.type].length,
                    ...
                    return GestureDetector(
                      onTap: () => _showDialog(
                          snap, index, snap.data.data[widget.type].length),
                      child: Card(
                        child: Container(
    ...
    return MainScaffold(
      ...
      GridView.count(
          ...
          children: List.generate(5, (index) {
            ...
            var pageData = [
              jewel_gemStudded_sets,
              jewel_gemStudded_pendants,
              jewel_gemStudded_tops,
              jewel_gemStudded_rings,
              jewel_gemStudded_bracelets
            ];

            var gemStuddedImageUrl = [
              'https://firebasestorage.googleapis.com/v0/b/gemselections-add52.appspot.com/o/jewellery-images%2Fgem-studded%2Fset%2FGSJS%201649001.png?alt=media&token=7f85787f-9561-4247-bf08-3faf290310ac',
    ...
    return MainScaffold(
      ...
      GridView.count(
          ...
          children: List.generate(8, (index) {
            ...
            var gemStuddedImageUrl = [
              'https://firebasestorage.googleapis.com/v0/b/gemselections-add52.appspot.com/o/jewellery-images%2Fdiamond%2Fset%2FDJS%207129001.png?alt=media&token=11186fb7-7aad-40b4-b02b-9be25bcdb191      ',
